...
float calculate_gpa(int a, int x[], int y[], float z[]) {
    ...
    for (int i = 0; i < a; i++) {
        ...
        if (x[i] <= 49) { z[i] = 0.0f; }
        else if (x[i] <= 52) { z[i] = 3.0f; }
        else if (x[i] <= 55) { z[i] = 4.0f; }
        else if (x[i] <= 59) { z[i] = 5.0f; }
        else if (x[i] <= 64) { z[i] = 6.0f; }
        else if (x[i] <= 69) { z[i] = 7.0f; }
        else if (x[i] <= 74) { z[i] = 8.0f; }
        else if (x[i] <= 79) { z[i] = 9.0f; }
        else if (x[i] <= 84) { z[i] = 10.0f; }
        else if (x[i] <= 89) { z[i] = 11.0f; }
        else if (x[i] <= 94) { z[i] = 11.5f; }
        else { z[i] = 12.0f; }
